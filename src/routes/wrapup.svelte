...
<ol>
	...
	สิ่งนึงที่เพิ่มตอนหลัง ๆ คือ สร้าง alias ให้ทุกคน เวลาอ่านใน Discord จะได้รู้ว่าใครตอบอะไรมา
	</li>
...
<h1 id="refelction">มองย้อน</h1>

<h2>ด้านของปริศนา</h2>
<p>ปริศนาด่านที่ 2 ซูมเป็นคนเขียน โดยได้ไป playtest และแก้บ้าง จึงละไว้ (เว้นแต่ว่าซูมจะเขียนเพิ่ม ก็จะเอามาไว้ตรงนี้)</p>
...
<ul>
	...
	อีกอย่างที่ปรับคือ เรียงตำแหน่งให้อ่านจากบนลงล่าง หรือซ้ายไปขวา อย่างใดอย่างหนึ่ง ทำให้ไม่ต้องใบ้ในแผนที่ว่าข้อมูลนี้เป็นตัวอักษรที่เท่าไหร่ เพราะถ้าหาข้อมูลครบแล้วคำตอบจะอ่านได้ชัด<br><br>
...
<div id="toc_container">
	...
	<ul class="toc_list">
		...
		<li><a href="wrapup#tools">เครื่องมือ</a></li>
		...
		<li><a href="wrapup#refelction">มองย้อน</a></li>
		<li><a href="wrapup#thanks">Thanks</a></li>
		<li><a href="wrapup#backstage">หลังเวที</a></li>
	</ul>
</div>
